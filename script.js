const API_KEY = 'bc37d32069444ac6b6811400dc8d9b1c';
...
function fetchNews(isSearching) {
    ...
    if (isSearching) {
        ...
        url = `https://newsapi.org/v2/everything?q=${keyword}&apiKey=${API_KEY}&page=${currentPage}&language=en`;
    } else {
        const category = currentCategory || document.getElementById('category').value;
        url = `https://newsapi.org/v2/top-headlines?country=in&category=${category}&apiKey=${API_KEY}&page=${currentPage}&language=en`;
    }
